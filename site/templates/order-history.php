<?php
    ...
    if ($input->get->ordn) {
        ...
        if (is_ordersaleshistory($ordn)) {
            ...
            $page->body = $config->twig->render('orders-history/order-history.twig', ['page' => $page, 'user' => $user, 'orderhistorydisplay' => $orderhistorydisplay, 'dplusdatetime' => $dplusdatetime, 'order' => $order, 'customer' => $customer]);
        } else {
