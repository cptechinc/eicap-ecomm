		...
		<div class="row form-group">
			<div class="col-sm-2 form-group">
				<?php if (!empty($item->product_image)) : ?>
					<img class="card-img-top rounded" src="<?= $item->product_image->size(100, 100)->url; ?>" alt="Card image cap">
				<?php else :?>
			...
			<div class="col-sm-8 form-group">
				<h5 class="card-title"><?= $item->itemid; ?></h5>
				<p class="card-text"><?= ucwords(strtolower($item->title)); ?></br>
				<?= htmlspecialchars_decode(ucwords(strtolower($item->name2))); ?></p>
			</div>
			<div class="col-sm-2 form-group">
				<div class="row">
					<div class="col">
