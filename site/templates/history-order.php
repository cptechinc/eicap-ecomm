<?php
    ...
    if ($input->get->ordn) {
        ...
        if (is_ordersaleshistory($ordn)) {
            ...
            $page->body = $config->twig->render('sales-history/history-order.twig', ['page' => $page, 'user' => $user, 'orderhistorydisplay' => $orderhistorydisplay, 'dplusdatetime' => $dplusdatetime, 'order' => $order, 'customer' => $customer]);
        } else {
